...
complete.dt <- na.omit(setkey(complete.dt,Stock)[stocks][,eps.pmafe:=abs(Est-act.eps)/mean(abs(Est-act.eps))])
...
eps.cont.tab <- lapply(c(1,4),function(i) {cont.tab.f(sample.rank,i,n.b)})
...
<<chap3-fig-mean-forecast,echo=FALSE, include=TRUE,results='hide',fig.width=10.7,fig.height=8.3,fig.cap='Average number of forecast per quarter',fig.lp='mean-f',fig.pos='hp'>>=
...
<<chap3-fig-num-forecast,echo=FALSE, include=TRUE,results='hide',fig.width=10.7,fig.height=8.3,fig.cap='Number of forecasts',fig.lp='num-f'>>=
...
<<chap3-fig-stocks-brok,echo=FALSE, include=TRUE,results='hide',fig.width=10.7,fig.height=8.3,fig.cap='Number of stocks per broker per quarter',fig.lp='num-s-b'>>=
...
<<chap3-fig-brok-stocks,echo=FALSE, include=TRUE,results='hide',fig.width=10.7,fig.height=8.3,fig.cap='Number of brokers per stock',fig.lp='num-b-s'>>=
