...
p.dt.cons <- dt2[dt1][,as.list(htest.short(t.test(ann.cum.ret,i.ann.cum.ret,alternative='t',paired=T))),by=.(Method,type,Views)][,sig:=ifelse(p<1/100,'***',ifelse(p<5/100,'**',ifelse(p<1/10,'*','(---)')))]

view <- 'Market'
dt1 <- setkey(cum.ret[Views==view],Quarters,Method,type)
dt2 <-setkey(cum.ret[Views!=view],Quarters,Method,type)

p.dt.mkt <- dt2[dt1][,as.list(htest.short(t.test(ann.cum.ret,i.ann.cum.ret,alternative='t',paired=T))),by=.(Method,type,Views)][,sig:=ifelse(p<1/100,'***',ifelse(p<5/100,'**',ifelse(p<1/10,'*','(---)')))]


t.stat.cons <- abind(acast(p.dt.cons,Views~type~Method,value.var='t'),acast(p.dt.cons,Views~type~Method,value.var='p'),along=4)


t.stat.mkt <- abind(acast(p.dt.mkt,Views~type~Method,value.var='t'),acast(p.dt.mkt,Views~type~Method,value.var='p'),along=4)


#dt2[dt1][,as.list(htest.short(t.test(ann.port.ret,i.ann.port.ret,alternative='t',paired=T))),by=.(Method,type,Views)][,sig:=ifelse(p<1/100,'***',ifelse(p<5/100,'**',ifelse(p<1/10,'*','(---)')))][]
...
#t.test(ret.dt[,'TP',1,1],ret.dt[,'CONS',1,1],alternative='t',paired=T)
@
...
\label{tab:sig}
\ The table demonstrates a pairwise statisitical test in difference of the cumulative returns of all strategies vs. \Market{} (Panel A) and vs. \textit{CONS} strategy (Panel B). Case of \tr{} shows  the known future information; \naive{} is the case of ranking information know at $t-1$, and the \default{} is the case of using all ranking information for up to $t-1$. \textit{TP} is the strategy with rankings based on the accuracy in target prices, \textit{CONS} is the strategy based on the consensus among the analysts regarding a stock's expected return. \textit{EPS} is the strategy with rankings based on the accuracy of EPS forecasts. Stocks in the \all{} sample are subsamples of the S\&P 500, stocks in the \same{} sample integrate both the EPS and TP datasets.
...
print(xtable(acast(melt(t.stat.mkt[,,1,]),Var1~Var2+Var3),display=c('s','f','f','f','f'),digits=3),only.contents=T,include.rownames=F,NA.string='-',include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(3,0,1,2),command=c('\\midrule \n','\\textit{CONS}&','\\textit{TP}&','\\textit{EPS}&')),sanitize.text.function = function(x) x)
@
\end{tabularx}
...
print(xtable(acast(melt(t.stat.mkt[,,2,]),Var1~Var2+Var3),display=c('s','f','f','f','f'),digits=3),only.contents=T,include.rownames=F,NA.string='-',include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(3,0,1,2),command=c('\\midrule \n','\\textit{CONS}&','\\textit{TP}&','\\textit{EPS}&')),sanitize.text.function = function(x) x)
@
\end{tabularx}
...
print(xtable(acast(melt(t.stat.mkt[,,3,]),Var1~Var2+Var3),display=c('s','f','f','f','f'),digits=3),only.contents=T,include.rownames=F,NA.string='-',include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(3,0,1,2),command=c('\\midrule \n','\\textit{CONS}&','\\textit{TP}&','\\textit{EPS}&')),sanitize.text.function = function(x) x)
@
\end{tabularx}
...
print(xtable(acast(melt(t.stat.cons[,,1,]),Var1~Var2+Var3),display=c('s','f','f','f','f'),digits=3),only.contents=T,include.rownames=F,NA.string='-',include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(3,0,1,2),command=c('\\midrule \n','\\textit{TP}&','\\textit{EPS}&','\\textit{Market}&')),sanitize.text.function = function(x) x)
@
\end{tabularx}
...
print(xtable(acast(melt(t.stat.cons[,,2,]),Var1~Var2+Var3),display=c('s','f','f','f','f'),digits=3),only.contents=T,include.rownames=F,NA.string='-',include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(3,0,1,2),command=c('\\midrule \n','\\textit{TP}&','\\textit{EPS}&','\\textit{Market}&')),sanitize.text.function = function(x) x)
@
\end{tabularx}
...
print(xtable(acast(melt(t.stat.cons[,,3,]),Var1~Var2+Var3),display=c('s','f','f','f','f'),digits=3),only.contents=T,include.rownames=F,NA.string='-',include.colnames=FALSE,hline.after=NULL, format.args=list(big.mark = " ", decimal.mark = "."),add.to.row=list(pos=list(3,0,1,2),command=c('\\bottomrule \n','\\textit{TP}&','\\textit{EPS}&','\\textit{Market}&')),sanitize.text.function = function(x) x)
@
\end{tabularx}
